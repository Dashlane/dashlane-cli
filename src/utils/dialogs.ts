    ...
    return password(
        {
            ...
            validate(input: string) {
                return input.length > 0 ? true : 'Master password cannot be empty';
            },
        },
        promptContext
    );
...
export const askReplaceIncorrectMasterPassword = () => {
    return confirm(
        {
...
export const askIgnoreBreakingChanges = () => {
    return select(
        {
            message:
...
export const askTokenRequestId = () => {
    return input(
        {
