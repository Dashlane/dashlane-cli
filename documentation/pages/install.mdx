...
The Dashlane CLI can be installed in multiple ways. You can either install it using [Homebrew](https://brew.sh/) on **macOS** and **Linux**,
manually with PNPM or download the packaged executables for **Windows**, **macOS** and **Linux** on x64 architectures.

<Tabs items={['Homebrew', 'Manually with PNPM', 'Packaged Executables (x64 only)']}>
    <Tab>
    ...
    <Tab>
    This method is available on every environment that supports [Node.js](https://nodejs.org/en/) and PNPM.
